...
<body>
  ...
  <section class="container project-body top-margin-3" id="background">
    ...
    <p>As a product designer, I have devoted myself to bringing joy and happiness to people’s lives. I believe in achieving my goal, we must first reduce the unnecessary suffering that each individual experiences. The story began when I was 12, I got into an accident which then sent me to the emergency room. To me, that was my first near-death experience. However, instead of being terrified of the pain, what left me a life long memory was my father’s worrying and crying face. As he held on to my fracture arm while waiting for the doctor, it was then I asked myself, what if I died today, what would happen to the people I love?</p>
