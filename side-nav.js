...
function scrollFunction() {
    if (document.body.scrollTop > 250 || document.documentElement.scrollTop > 250) {
        ...
        document.getElementById("sidebar-1").style.left = "35px";
        document.getElementById("sidebar-2").style.left = "35px";
        document.getElementById("sidebar-3").style.left = "35px";
        document.getElementById("sidebar-4").style.left = "35px";
    }else {
